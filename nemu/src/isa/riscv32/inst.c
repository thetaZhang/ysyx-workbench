...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, R(rd) = (sword_t)(((int64_t)src1 * (int64_t)src2) >> (8 * sizeof(word_t)/sizeof(uint8_t))));
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, R(rd) = (sword_t)((signed)src1 / (signed)src2));
